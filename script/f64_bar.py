...
plt.bar(x , data_cusp, width,color='#f6b654',edgecolor='black', linewidth=1.5,label='cuSPARSE v12.0')
plt.bar(x + (width*1), data_dasp, width,color='#ee6a5b',edgecolor='black',linewidth=1.5, label='DASP (this work)')
